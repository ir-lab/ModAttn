...
def step(data, model, optimizer, criterion, criterion2, stage, writer, epoch_idx, idx, len_data_loader):
    ...
    # Log and print
    if epoch_idx * len_data_loader + idx % 100 == 0:
...
def train(writer, name, epoch_idx, data_loader, data_loader_dmp, model, 
    ...
    if stage == 0 or stage == 1:
        ...
        loader = data_loader_dmp
        
    for data in loader:
        global_step = epoch_idx * len(data_loader) + idx
        step(data, model, optimizer, criterion, criterion2, stage, writer, epoch_idx, idx, len(loader))
        idx = idx + 1
...
if __name__ == '__main__':
    name = 'train-rgb-sub-attn-abs-action-vision-embed-3-stage-dalle-1-obj'
