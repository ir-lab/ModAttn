...
from utils.load_data_rgb_abs_action_fast_gripper_finetuned_attn_vision_embed_dalle_1_obj import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
if __name__ == '__main__':
    name = 'train-rgb-sub-attn-abs-action-vision-embed-3rd-stage-dalle-1-obj'
